...
const modelfile = `
FROM llama3.2:1b
SYSTEM "You are a helpful assistant. Please form your response as html and make it logically fit within the following div: "<div class="llm-text"></div>". Keep your responses concise."
`;
